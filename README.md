...
```bibtex
@misc{aghamohammadi2025hybrid,
  title={Hybrid GNN-Flux Integrators for 1D Fluid-Poisson Dynamics},
  author={Aghamohammadi, Yeganeh and Xia, Jingtao and Dirksen, Shane and Zhong, Frank},
  year={2025},
...
We thank Professor Sanjukta Krishnagopal for guidance and feedback, particularly for pointing out connections to ENO/WENO schemes.
